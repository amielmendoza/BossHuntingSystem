...
- Create Angular project with ng: `ng new bosshuntingsystem.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`bosshuntingsystem.client.esproj`).
